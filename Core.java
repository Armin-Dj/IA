...
public class Core {
    ...
    public static void arataRezultat(Algoritm algo) {
        ...
        System.out.println("Numar nod vizitat: " + algo.getNodVizitat());
        System.out.println("Numar nod expandat: " + algo.getNodExpandat());
        System.out.println("Numar nod in memorie: " + algo.getmaxNodInMemorie());
    }
}
